            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('words.update', $word->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" class="shadow border rounded w-full py-2 px-3 text-gray-700 focus:outline-none" value="{{ old('name', $word->name) }}" required>
                    </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div>
                                <input type="checkbox" id="theme_{{ $theme->id }}" name="themes[]" value="{{ $theme->id }}" class="mr-2"
                                    @if($word->themes->contains($theme->id)) checked @endif>
