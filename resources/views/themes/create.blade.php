            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('themes.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="theme" name="theme" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('theme') }}" required>
                        @error('theme')
